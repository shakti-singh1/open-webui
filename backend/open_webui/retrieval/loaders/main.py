...
class RobustDocxLoader:
    """
    A robust DOCX loader that handles non-standard .docx files where the main
    ...
    def load(self) -> list[Document]:
        ...
        if main_doc_path != "word/document.xml":
            ...
            # Standard path, use docx2txt directly
    ...
    def _get_loader(self, filename: str, file_content_type: str, file_path: str):
        ...
        if (
            ...
            if file_ext == "pdf":
                ...
                loader = RobustDocxLoader(file_path)
